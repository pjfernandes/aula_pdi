...
// Treinando classificador
var classifier = ee.Classifier.smileGradientTreeBoost(500).train({
  features: training,
  classProperty: 'class',
  inputProperties: bands
});
...
Map.addLayer(classified, {
  ...
  max: 3,
  palette: ['green', 'red', 'blue']
}, 'GradientTreeBoost classification');
...
// Treinando classificador
var classifier = ee.Classifier.minimumDistance('mahalanobis').train({
  features: training,
  classProperty: 'class',
  inputProperties: bands
});
